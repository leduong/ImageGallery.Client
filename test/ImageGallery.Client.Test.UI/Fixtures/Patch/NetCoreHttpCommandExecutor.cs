...
namespace ImageGallery.Client.Test.UI.Fixtures.Patch
{
    ...
    public class NetCoreHttpCommandExecutor : ICommandExecutor
    {
        ...
        public NetCoreHttpCommandExecutor(Uri addressOfRemoteServer, TimeSpan timeout)
        ...
        public NetCoreHttpCommandExecutor(Uri addressOfRemoteServer, TimeSpan timeout, bool enableKeepAlive)
        {
